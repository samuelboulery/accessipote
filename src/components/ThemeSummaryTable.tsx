...
function ThemeSummaryTable({ themes, mode }: ThemeSummaryTableProps) {
  return (
    <div className="overflow-x-auto">
      <table className="w-full border-collapse text-sm dark:bg-gray-800 dark:text-gray-100">
        <thead>
        ...
        <tbody>
          {themes.map((theme) => (
            ...
            >
              <td className="text-left px-4 py-3 font-medium text-gray-900 dark:text-gray-100">
                {theme.theme}
              </td>
              {mode === 'classic' ? (
                <>
                  <td className="text-center px-4 py-3 text-green-600 dark:text-green-400 font-semibold">
                    {theme.conforme}
                  </td>
                  <td className="text-center px-4 py-3 text-red-600 dark:text-red-400 font-semibold">
                    {theme.nonConforme}
                  </td>
                </>
              ) : (
                <>
                  ...
                  <td className="text-center px-4 py-3 text-teal-600 dark:text-teal-400 font-semibold">
                    {theme.projectImplementation}
                  </td>
                </>
              )}
              <td className="text-center px-4 py-3 text-gray-600 dark:text-gray-400 font-semibold">
                {theme.nonApplicable}
              </td>
